...
contract TokenPrice is ChainlinkClient, Ownable {
  ...
  event RequestEthereumPriceFulfilledJPY(bytes32 indexed requestId, uint256 indexed price);
  ...
  /**
        _oracle: "0xc99B3D447826532722E41bc36e644ba3479E4365"
        _jobId: "3cff0a3524694ff8834bda9cf9c779a1"
  */
  ...
  function requestEthereumChange(address _oracle, string _jobId) public onlyOwner
  {
  ...
  function requestEthereumLastMarket(address _oracle, string _jobId) public onlyOwner
  {
  ...
  function fulfillEthereumLastMarket(bytes32 _requestId, bytes32 _market) public recordChainlinkFulfillment(_requestId)
  {
